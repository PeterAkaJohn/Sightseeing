      ...
      <div id="map" style={{height: '100vh', width:'100vw'}}>
        {this.props.locations.map(location => {
          if(this.props.map != null && this.props.bounds != null){
            return <MapMarkerContainer key={location.id} location={location} {...this.props}></MapMarkerContainer>
          }
        })}
      </div>
    )
...
@scriptLoader(['https://maps.googleapis.com/maps/api/js?key=AIzaSyDSSIeGc4in6qVsJE6BwSSLBS5RlqkHRm4'])
class MapContainer extends Component {
  ...
  render() {
    return (
      <Map {...this.props} {...this.state} map={this.map} bounds={this.bounds} ></Map>
    )
  }
}
